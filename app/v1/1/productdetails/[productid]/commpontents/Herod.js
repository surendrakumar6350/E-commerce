    ...
    <div className="grid gap-8 md:grid-cols-2">
      ...
      <div className="space-y-4">
        <div className="relative overflow-hidden rounded-lg bg-gray-100">
          <img src={data?.imageUrl} loading="lazy" alt="Photo by Himanshu Dewangan" className="h-full w-full object-cover object-center" />

          <span className="absolute left-0 top-0 rounded-br-lg bg-red-500 px-3 py-1.5 text-sm uppercase tracking-wider text-white">{data?.sale}</span>
        </div>
      ...
      <div className="md:py-8">
        ...
        <div className="mb-4">
          <div className="flex items-end gap-2">
            ...
            <span className="mb-0.5 text-red-500 line-through">{data?.cuttingrate}</span>
          </div>
